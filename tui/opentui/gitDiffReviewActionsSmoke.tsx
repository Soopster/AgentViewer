...
import { copyDiffRows, diffMatchRanges, findDiffTextMatches, highlightDiffMatches } from './gitDiffReviewActions'
...
try {
  ...
  lines[10] = `needle\t界 ${'x'.repeat(130)} TAIL`; lines[350] = 'NEEDLE second'
  ...
  try {
    await until(() => frame().includes('row-0'), 'initial review')
