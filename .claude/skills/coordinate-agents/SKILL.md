...
Read `.agents/skills/coordinate-agents/SKILL.md` completely, then follow that canonical workflow for this session. Treat it as standing instructions until the Coordinator run becomes terminal.
