...
// Every session with a turn running in THIS server process, including any
// provider-native approvals/questions the turn is blocked on. Process-local,
// like the per-session /running probe. Powers remotely-attached TUIs (fleet
// strip, attention inbox, live-turn reattach).
